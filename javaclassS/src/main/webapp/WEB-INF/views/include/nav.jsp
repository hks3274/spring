...
<script>
  ...
  // 카카오 로그아웃
  window.Kakao.init("c91a3e0bd9ff7e7021b35c38ed8c2290");
  function kakaoLogout() {
	  const accessToken = Kakao.Auth.getAccessToken();
	  if(accessToken) {
		  Kakao.Auth.logout(function() {
			  window.location.href =  "https://kauth.kakao.com/oauth/logout?client_id=c91a3e0bd9ff7e7021b35c38ed8c2290&logout_redirect_uri=http://localhost:9090/javaclassS/member/memberLogout";				
			});
	  }
  }
</script>
