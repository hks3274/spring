  ...
  <table class="table table-bordered">
    ...
    <tr>
      <td colspan="4">
        <div class="row">
	        <div class="col">
	        	<c:if test="${flag == ''}"><input type="button" value="돌아가기" onclick="location.href='boardList?pag=${pag}&pageSize=${pageSize}';" class="btn btn-warning" /></c:if>
	        	<c:if test="${flag != ''}"><input type="button" value="돌아가기" onclick="location.href='boardSearch?pag=${pag}&pageSize=${pageSize}&search=${search}&searchString=${searchString}';" class="btn btn-warning" /></c:if>
	        </div>
