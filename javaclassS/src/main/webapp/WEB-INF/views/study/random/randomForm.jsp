...
<div class="container">
	...
	<div>알파벳과 숫자를 랜덤하게 출력시킬 수 있다.</div>
	<hr/>
	<div>
		<input type="button" value="Numeric" onclick="randomCheck()" class="btn btn-success mr-2"/>
		<input type="button" value="UUID(16진수)" onclick="uuidCheck()" class="btn btn-success mr-2"/>
		<input type="button" value="AlphaNumeric" onclick="randomAlphaNumericCheck()" class="btn btn-info mr-2"/>
		<input type="reset" value="새로고침" onclick="location.reload()" class="btn btn-warning"/>		
	</div>
	<hr/>
	<div>
		<div>출력결과</div>
