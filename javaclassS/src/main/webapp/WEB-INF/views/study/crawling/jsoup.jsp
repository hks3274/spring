...
<head>
    ...
    function crawling4() {
    	...
    	if(searchString.trim() == "") {
    		alert("검색어를 입력하세요");
    		document. document.getElementById("searchString").focus();
    		return false;
    	}
    	if( page.trim() == "") page = 1;
...
<div class="container">
	...
	<form name = "myform" >
		...
		<select name ="url" id="url" class="form-control">
			...
			<option >2.네이버뉴스이미지-https://news.naver.com/</option>
			<option >3.네이버뉴스언론사이름-https://news.naver.com/</option>
		</select>	
		</div>
		<div class="input-group mb-3">
		...
		<div><input type="button" value="크롤링2(네이버 헤드라인뉴스)" onclick="crawling2()" class="btn btn-primary mb-2"/></div>
		<div><input type="button" value="크롤링3(다음 연예소식)" onclick="crawling3()" class="btn btn-primary"/></div>
	</form>
	 <hr>
		<div class="input-group mb-3">
		...
		<div class="input-group mb-3">
		<div class="input-group-text">네이버 검색어로 검색(page번호)</div> 
