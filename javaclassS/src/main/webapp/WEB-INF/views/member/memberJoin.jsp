        ...
        return false;
			...
			if(fName.trim() != "") {
				...
				if(ext != 'jpg' && ext != 'gif' && ext != 'png') {
					...
					alert("업로드할 파일의 최대용량은20MByte입니다.");
					return false;
				}
			}
			else myform.photo.value = 'noimage.jpg';		
...
<div class="container">
  ...
  <!-- <form name="myform" method="post" class="was-validated"> -->
    ...
    <div  class="form-group">
      회원 사진(파일용량:2MByte이내) :
      <input type="file" name="fName" id="fName" onchange="imgCheck(this)" class="form-control-file border" accept=".jpg,.gif,.png,.zip,.ppt,.pptx,.hwp"/>
